...
export default function ListarCategorias ({ setAlert, windowHeight, isMaximized, permisos }) {
  ...
  const {
    ...
    maxPage,
    fetchElements
  } = useFetch({ setAlert, windowHeight, isMaximized, obtener: 'categorias' })

  const { submitData } = useEdit({ setAlert, obtener: 'categoria' })
  ...
  const {
    ...
    setShowModal,
    handleDeactivate
  } = useDeactivate({ setAlert, obtener: 'categoria', fetchElements })

  const {
    formRef,
    handleSubmit
  } = useCreate({ setAlert, obtener: 'categoria', fetchElements })
