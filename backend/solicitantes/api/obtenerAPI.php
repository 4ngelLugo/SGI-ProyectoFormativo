...
require_once '../Controller/SolicitanteController.php';
...
$controller = new SolicitanteController($conexion);
...
if (isset($_GET["documento"])) {
  ...
  $resultado = $controller->obtenerSolicitantePorDocumento($documento);
} else {
  $resultado = $controller->obtenerTodosLosSolicitantes();
}
