...
if (isset($_GET["tipo_documento_id"]) && is_numeric($_GET["tipo_documento_id"])) {
  $id = (int) $_GET["tipo_documento_id"];

  $resultado = $controller->obtenerTipoDocumentoPorId($id);
} else {
  $resultado = $controller->obtenerTodosLosTipoDocumentos();
}
