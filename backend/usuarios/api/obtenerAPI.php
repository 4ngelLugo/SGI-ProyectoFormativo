...
// Si se hace la petición con un documento específico, se obtiene ese usuario. Sino se obtienen todos
if (isset($_GET["documento"])) {
  $documento = (int) $_GET["documento"];

  $resultado = $controller->obtenerUsuarioPorDocumento($documento);
} else {
  $resultado = $controller->obtenerTodosLosUsuarios();
}
